class RepairRequestGetModemLogModelResponse {
  int? id;
  dynamic idLong;
  dynamic parentId;
  ...
  RepairRequestGetModemLogModelResponse({
    this.id,
    this.idLong,
    this.parentId,
    this.parentIdLong,
  ...
  factory RepairRequestGetModemLogModelResponse.fromJson(
    Map<String, dynamic> json,
  ) {
    return RepairRequestGetModemLogModelResponse(
      id: json['ID'] as int?,
