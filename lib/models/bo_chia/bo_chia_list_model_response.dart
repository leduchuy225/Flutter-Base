class BoChiaListModelResponse {
  ...
  factory BoChiaListModelResponse.fromJson(Map<String, dynamic> json) {
    return BoChiaListModelResponse(
      id: json['ID'] as int?,
