class CloseNewInstallationResponse {
  bool? isClosed;
  String? closedBy;
  String? closedDate;
  String? closedNote;
  ...
  factory CloseNewInstallationResponse.fromJson(Map<String, dynamic> json) {
    return CloseNewInstallationResponse(
