...
part of 'selector_retrofit_api.dart';
...
class _SelectorRetrofitApi implements SelectorRetrofitApi {
  _SelectorRetrofitApi(this._dio, {this.baseUrl, this.errorLogger});
